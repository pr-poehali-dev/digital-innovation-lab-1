                  ...
                  {[
                    {
                      regime: "📈 Тренд",
                      color: "text-green-400",
                      signal: "ADX > 25, EMA расходятся",
                      action: "Трендовые входы, EMA-кросс, пробои",
                      risk: "1–2% на сделку",
                    ...
                    },
                    {
                      regime: "↔️ Боковик",
                      color: "text-blue-400",
                      signal: "ADX < 20, цена в канале",
                      action: "Отскоки от уровней, RSI, сетка",
                      risk: "0.5–1% на сделку",
                      riskColor: "text-blue-400",
                    },
                    {
                      regime: "⚡ Волатильность",
                      color: "text-yellow-400",
                      signal: "ATR > 1.5× нормы",
                      action: "Пропуск или минимальные ставки",
                      risk: "0.25–0.5% или пропуск",
                      riskColor: "text-yellow-400",
                    },
                    {
                      regime: "🔄 Переход",
                      color: "text-zinc-400",
                      signal: "ADX 20–25, EMA сближаются",
                      action: "Ждать. Не торговать.",
                      risk: "Пропуск",
